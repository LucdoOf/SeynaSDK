...
function autoloader($class) {
    ...
    if (file_exists(SDK_ROOT . $class . ".php")) {
        ...
        if (file_exists(SDK_ROOT . "utils/" . $class . ".php")) {
            include SDK_ROOT . "utils/" . $class . ".php";
        } else {
            if (file_exists(SDK_ROOT . "src/model/" . $class . ".php")) {
                include SDK_ROOT . "src/model/" . $class . ".php";
            } else {
                if (file_exists(SDK_ROOT . "src/core/" . $class . ".php")) {
                    include SDK_ROOT . "src/core/" . $class . ".php";
                } else {
                    if (file_exists(SDK_ROOT . "api/" . $class . ".php")) {
                        include SDK_ROOT . "api/" . $class . ".php";
                    } else {
                        if (file_exists(SDK_ROOT . "src/core/database/" . $class . ".php")) {
